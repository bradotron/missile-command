...
{
  private readonly string[] popupOptions = { "Constant", "Use Variable" };
  ...
  public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
  {
    ...
    int result = EditorGUI.Popup(buttonRect, isConstant.boolValue ? 0 : 1, popupOptions, popupStyle);

    isConstant.boolValue = result == 0;

    EditorGUI.PropertyField(position,
      isConstant.boolValue ? constant : variable,
      GUIContent.none);
